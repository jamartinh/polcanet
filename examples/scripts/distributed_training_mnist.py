...
from polcanet import PolcaNetConfig, PolcaNetPythae
from polcanet.polcanet_model import LinearDecoderPythae
...
def main(args):
    ...
    model = PolcaNetPythae(model_config=model_config, encoder=encoder, decoder=decoder)

    gpu_ids = [0, 1, 2, 3]

    training_config = BaseTrainerConfig(
        num_epochs=100,
        output_dir="polcanet_mnist",
